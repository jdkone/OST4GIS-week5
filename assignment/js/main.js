...
//var downloadData =
//$.ajax('https://raw.githubusercontent.com/CPLN-692-401/datasets/master/json/philadelphia-solar-installations.json')
//.then(JSON.parse);
...
/*var makeMarkers = function(array) {
  _.forEach(array, function(object) {
    return L.marker(object.LAT, object.LONG_);
  });
};
*/
var makeMarkers = function(array) {
  return _.map(array, function(obj){
    return L.marker([obj.LAT,obj.LONG_]);
  });
};
...
var plotMarkers = function(array) {
  return _.map(array, function(mark) {
    return mark.addTo(map);
  });
};
...
var removeMarkers = function(array) {
  return _.each(array, function(mark){
...
//Add code for the button event
var callback = function() {
  var input1 = $("#input1").val();
  var input2 = $("#input2").val();
  var input3 = $("#input3").val();
  var form = {
    "Url": input1, "LAT": input2, "LONG_": input3
  };
  return form;
};
...
$("button").click(function() {
  callback();
  downloadData = $.ajax(input1).then(JSON.parse);
